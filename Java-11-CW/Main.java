class Main {
  ...
  System.out.println("Username: "+createUsername("Bruce", "Wayne", "2323232332"));
  System.out.println("Username with email: "  + getUsername("Adrianxc13483@gmail.com"));
  System.out.println("Words in reverse: " + splitReverse("Blue","Bash"));
...
*\
  ...
  */
  ...
  String splitReverse(String half1, String half2){
      return half2.substring(0) + half1.substring(0);
    }
