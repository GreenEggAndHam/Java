class Main {
  ...
  System.out.println(groupSavings(27));
  System.out.println(groceryDiscount(12,12));
  System.out.println(groceryDiscount(126,13));
  System.out.println(groceryDiscount(212,125));    
  }
