...
print(generatePIN());
  ...
  */
String generatePIN(){
  int numero = (int)(Math.random()*(8-3+1))+3;
  int numera = (int)(Math.random()*(8-3+1))+3;
  int numeru = (int)(Math.random()*(8-3+1))+3;
  int numere = (int)(Math.random()*(8-3+1))+3;
  return "" + numero+ numera+numeru+numere;
}
