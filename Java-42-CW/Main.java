...
class Main {
 ...
 public static void main(String[] args)throws IOException{
  ...
  void init() {
    ...
    sql = "INSERT INTO students(studentid,course,section,period,teacher,room) VALUES ('STUDENT2','MCLUB1',3,1,'WHOKNOWS','ROOFTOP');";
      db.runSQL(sql);
    
    
    // 2: For student with ID “STUDENT4”, add course “CN100” with a section 1, teacher1 as  “JOSEPH”, period 2 and room 108.
    sql = "INSERT INTO students(studentid,course,section,period,teacher,room) VALUES ('STUDENT4','CN100',1,2,'JOSEPH',108);";
      db.runSQL(sql);
