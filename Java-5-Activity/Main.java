...
*/
    ...
    double grade2 = 90.56;
    double grade3 = 87.92;
    double add = grade1+grade2+grade3;
    System.out.println("the mighty sum of the grades is " + add);
...
*/
double house = (grade1+grade2+grade3)/3;
System.out.println("the mighty average of them is "+ house);
...
System.out.println("For EQ1, the result shall be: " + eq1);
...
System.out.println("For EQ2, the result shall be: " + eq2);
...
int h = 7;
double area = ((0.5)*b*h);
System.out.println("For EQ3, the result shall be: " + area);
...
int eggs = 100;
int basket = 12;
int johnny = eggs/basket;
int moldy = eggs%basket;
System.out.println("You can fill " + johnny + " baskets of 12 eggs");
System.out.println("But there will be " + moldy+ " eggs left over.");
