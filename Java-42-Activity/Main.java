...
class Main {
 ...
 public static void main(String[] args)throws IOException{
  ...
  void init() {
    ...
    sql = "DELETE FROM cr101 WHERE studentid= 'STUDENT1200';";
    db.runSQL();
    ...
    sql = "UPDATE cr101 SET teacher1 = 'ROFFLER' WHERE course = 'MQF44QGF' AND section = 1;";
    db.runSQL();
    ...
    sql = "INSERT INTO cr101 (course, teacher1,period,room,studentid,section) values ('MKUFTC6','CASTRO R',9,322,'student1231',1);"          
