class Main {
  ...
  void init(){
   System.out.println(creditCardType("4"));
   System.out.println(pigLatin("BarryAllen"));
   System.out.println(nycLocate("11416"));
   System.out.println(getMonth("04/22/2025"));
   System.out.println(validatePswd("BigBo1"));
  }
/*
    Challenge 1:
    ...
    */
    String creditCardType(String cardnum){
      ...
      else if (cardnum.substring(0,1).equals("37") || cardnum.substring(0,1).equals("34")){
    ...
    */
    String nycLocate(String zip){
      ...
      else return "My apologies, but your ZIP is not in New York";
  ...
  */
    ...
    else return "Sorry I cannot help you, goofball";
    }
    /*
    Challenge 5:
